...
- Kiểm tra cấu hình và quy ước: path aliases, theme, i18n, navigation types, Firebase (react-native-firebase).

## 2) Làm rõ vấn đề
- Xác định mô tả vấn đề: triệu chứng, màn hình/flow bị ảnh hưởng, môi trường (iOS/Android), phiên bản.
...
- Kiểm tra lớp liên quan: UI (screens/components), hooks, services, navigation, i18n, theme, Firebase.
- Dùng công cụ: Metro logs, React Native Debugger, console tracing, Jest unit tests, TypeScript strict.
