...
Mục đích: Chuẩn hóa cách đánh giá và xử lý các thay đổi/bug có “blast radius” lớn, ảnh hưởng nhiều components/screens/services. Tài liệu này giúp ra quyết định Go/No-Go, giảm rủi ro và bảo toàn hành vi hiện có.
...
- Outbound: đối tượng phụ thuộc những gì? (theme tokens, i18n keys, navigation types, Firebase collections)
